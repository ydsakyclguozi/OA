    ...
    <table class="table table-border table-bordered table-hover table-bg">
        ...
        <c:forEach items="${pageInfo.list}" var="menu">
            <tr class="text-c">
                ...
                <td class="f-14">
                    <a title="解除授权" href="javascript:;" onclick="del_role_menu(this,${menu.menuId})" class="ml-5"
...
<script type="text/javascript">
    ...
    function del_role_menu(obj, id) {
        layer.confirm('确定要解除与该用户的关系？', function (index) {
            //发送ajax请求去删除该条数据
            $.ajax({
                url: "authorization/delMenuFormRole",
                type: "POST",
                data: "menuId=" + id+"&roleId="+${params}.roleId,
                success: function (data) {
                    if (data.result) {

                        layer.msg('解除授权成功!', {icon: 1, time: 2000});
                        $(obj).parents("tr").remove();
                    } else {
                        layer.msg('解除授权失败!', {icon: 2, time: 2000});
                    }
